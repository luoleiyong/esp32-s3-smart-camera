...
- **SD Card Storage**: SD_MMC support for photo storage
...
### Storage
- **MicroSD Card**: SD_MMC interface (1-bit mode)
  - CLK: GPIO 39
  - CMD: GPIO 38
  - D0: GPIO 40
...
- Ensure backlight pin (TFT_BL) is configured correctly
...
- TJpg_Decoder library contributors
